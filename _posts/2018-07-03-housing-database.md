...
Most of the SQL used for this project is on my [repo](https://github.com/AlyssaYelle/RentalsDatabase), but an example of a query used to pull the data used for these plots is:
```SQL
